...
| Project | Description |
|---------|-------------|
| [watchwire](https://github.com/maxmccutcheon59/watchwire) | **Flagship** — local-first defensive CLI + GitHub Action + pre-commit: secret leak scan, `/proc` hygiene, permission checks |
