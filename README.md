...
Computer Science and Mathematics at James Madison University. I build AI software and the systems underneath it: storage engines, evaluation and sandboxing for AI agents, robotics simulation and control, and security tooling.
...
| [twistdiff](https://github.com/maxmccutcheon59/twistdiff) | ODE integration and PID control, with plotted demos | Python |

Also: [tinystories-scratch](https://github.com/maxmccutcheon59/tinystories-scratch) (a small GPT built from scratch) and [trailboard](https://github.com/maxmccutcheon59/trailboard) (a React and TypeScript app).
