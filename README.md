...
| Project | Description |
|---------|-------------|
| [watchwire](https://github.com/maxmccutcheon59/watchwire) | **Flagship** (`v0.2.0`) — local-first defensive CLI + Action + pre-commit; JSON/SARIF secret scan, `/proc` hygiene, permission checks |
