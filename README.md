...
| Project | Description |
|---------|-------------|
| [watchwire](https://github.com/maxmccutcheon59/watchwire) | **Flagship** (`v0.3.0`) — local-first defensive CLI + Action + pre-commit; policy file, JSON/SARIF secret scan, `/proc` hygiene, permission checks |
